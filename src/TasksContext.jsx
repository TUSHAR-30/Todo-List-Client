...
export function TasksProvider({ children }) {
    const [tasks, setTasks] = useState([
        ...
        { id: 3, title: 'Completing DSA course', isCompleted: true , description:"This is DSA" ,dueDate:"2024-12-02"},
        { id: 4, title: 'Yoga', isCompleted: false , description:"This is Yoga" ,dueDate:"2024-11-20"},
    ]);
